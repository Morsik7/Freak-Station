...
public static class AntagTokenCatalog
{
    ...
    private static readonly Dictionary<string, AntagRoleDefinition> RoleDefinitions = new()
    {
        ...
        [SlaughterDemonRole] = new(SlaughterDemonRole, "antag-store-role-slaughter-demon-name", "antag-store-role-slaughter-demon-description", 10,
            ...
            TagLocKey: "antag-token-window-tag-ghost",
            RequiresInRound: true),
        [SlasherRole] = new(SlasherRole, "antag-store-role-slasher-name", "antag-store-role-slasher-description", 5,
            "/Textures/_Goobstation/Actions/slashericons.rsi/SummonMachete.png", AntagPurchaseMode.GhostRule, null, "TokenSlasherSpawn",
            TagLocKey: "antag-token-window-tag-ghost",
            RequiresInRound: true),
        ...
        [ShadowlingRole] = new(ShadowlingRole, "antag-store-role-shadowling-name", "antag-store-role-shadowling-description", 6,
            ...
            MinimumPlayers: 30,
            RequiresPreRoundLobby: true),
        [XenomorphRole] = new(XenomorphRole, "antag-store-role-xenomorph-name", "antag-store-role-xenomorph-description", 5,
            "/Textures/_White/Mobs/Aliens/Xenomorphs/larva.rsi/xenomorph.png", AntagPurchaseMode.LobbyDeposit, "XenomorphsInfestationRoundstart", "XenomorphsInfestationRoundstart",
            TagLocKey: "antag-token-window-tag-queue",
            MinimumPlayers: 30,
            RequiresPreRoundLobby: true),
        [AgentRole] = new(AgentRole, "antag-store-role-agent-name", "antag-store-role-agent-description", 2,
