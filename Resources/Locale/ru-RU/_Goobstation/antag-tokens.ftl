...
antag-token-window-button-free = Бесплатно разблокировать
...
antag-token-window-tooltip-ghost = Потратить билеты и зарезервировать эту гост-роль только за собой.
