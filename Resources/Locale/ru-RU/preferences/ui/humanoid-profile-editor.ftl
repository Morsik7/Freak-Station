...
humanoid-profile-editor-erp-consent-label = Статус ERP:
humanoid-profile-editor-non-con-label = Статус Non-Con:
...
humanoid-profile-editor-erp-consent-disabled = Выключено
humanoid-profile-editor-erp-consent-enabled = Включено
humanoid-profile-editor-non-con-off = Запрещено
humanoid-profile-editor-non-con-on = Разрешено
